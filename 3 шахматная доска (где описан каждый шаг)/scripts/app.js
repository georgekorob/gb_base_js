let app = {
    ...
    insertPawns() {
        ...
        let whitePawnsRow = document.querySelectorAll('tr:nth-child(7) td'); // td[data-rownum="2"]
        ...
        let blackPawnsRow = document.querySelectorAll('tr:nth-child(2) td'); // td[data-rownum="7"]
    ...
    generateBoard() {
        ...
        let board = ''
        // Можно задавать rowStartWithColor с помощью проверки деления с остатком
        ...
        this.config.rows.forEach((r) => {
            ...
            if (r % 2 === 0) {
                ...
                row = this.generateRow('white', r);
            } else {
                // 3.7 делаем то же что и в п. 1.5
                row = this.generateRow('black', r);
            }
    ...
    generateRow(startWithColor, rowNum) {
        ...
        this.config.cols.forEach((c) => {
            ...
            if (currentColorClass === 'white') {
                ...
                field = this.generateField(currentColorClass, rowNum, c);
